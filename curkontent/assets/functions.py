...
async def join(client, invite_link):
    try:
        ...
        return "Berhasil bergabung dengan Channel"
        ...
        print(e)
        return f"{e} \nTidak dapat bergabung, coba bergabung secara manual."
...
async def force_sub(client, channel, id, ft):
    ...
    try:
        ...
        s, r = True, "KESALAHAN: Tambahkan saluran ForceSub, atau periksa id saluran Anda."
    return s, r
